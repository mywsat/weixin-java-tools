 ...
 */
public class CpOpenInRedisConfigStorage extends WxSuieInMemoryConfigStorage {

  private final static String SUITE_TICKET_KEY = "suite_ticket:";
  private final static String SUITE_ACCESS_TOKEN_KEY = "suite_access_token:";


  private final static String ACCESS_TOKEN_KEY = "cp_access_token:";
  private final static String JSAPI_TICKET_KEY = "cp_jsapi_ticket:";
  private final static String PERMANENT_CODE_KEY = "cp_permanent_code:";
  private final static String AGENTID_KEY = "cp_agent:";
  ...
  public CpOpenInRedisConfigStorage(JedisPool jedisPool) {
