package me.chanjar.weixin.third.mini.util.xml;
...
public class XStreamTransformer {
  ...
  static {
    registerClass(CpOpenXmlMessage.class);
  }
  ...
  private static void registerClass(Class<?> clz) {
    ...
    if (clz.equals(CpOpenXmlMessage.class)) {
      // 操蛋的微信，模板消息推送成功的消息是MsgID，其他消息推送过来是MsgId
      xstream.aliasField("MsgID", CpOpenXmlMessage.class, "msgId");
    }
