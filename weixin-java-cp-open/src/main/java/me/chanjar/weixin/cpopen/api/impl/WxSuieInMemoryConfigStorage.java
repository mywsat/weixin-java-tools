 ...
 */
public class WxSuieInMemoryConfigStorage implements CpOpenConfigStorage {
  ...
  private static class WxOpenCpConfigStorage implements WxCpConfigStorage {
    ...
    private WxOpenCpConfigStorage(CpOpenConfigStorage cpOpenConfigStorage, String corpId) {
